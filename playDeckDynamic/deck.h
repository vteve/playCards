...
namespace playDeckDynamic{
    ...
    public:
        ...
        /*!
         *
         * @param secondDeck copy this deck to object(this) by value
         */
        Deck(const Deck &secondDeck);

        /*!
         *
         * @param secondDeck copy this deck to object(this) by addres
         */
        Deck(Deck &&secondDeck) noexcept;

        /*!
         * delete playCards::Card deck
         */
        ~Deck(){delete[] deck;}
         ...
         */
        bool checkAvailabilityCard(int rank, playCards::Card::suits suit, int currentSize); //есть ли карта в колоде
        ...
        playCards::Card *getDeck() {
            return deck; //получить колоду типа *cards
        }
        ...
        /*!
         *
         * @param secondDeck deck from where we will copy our object by value
         * @returns object (*this)
         */
        ...
        /*!
         *
         * @param secondDeck deck from where we will copy our object by address
         * @returns object (*this)
         */
        Deck &operator=(Deck &&secondDeck) noexcept ;
